                        ...
                        <div class="row py-lg-2">
                            <div class="col-12 col-lg-10">
                                <div class="row">
                                    ...
                                    <div class="input-group col-12 col-lg-4">
                                        ...
                                        <select class="form-control pl-2" name="fop" wire:model.defer="status">
                            ...
                            <div class="col-12 col-lg-2">
                                <div class="row d-flex">
                                    ...
                                    @else
                                    <div class="col-12 pt-2 py-lg-2 d-flex justify-content-center align-item-center ">


                                        <span class="text-success">This order is active</span>
