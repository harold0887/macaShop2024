                ...
                <div class="card">
                    ...
                    <div class="card-body row">
                                ...
                                <div class="col-12 ">
                                    <div class="row text-xxs">
                                        ...
                                        <div class="col-12 col-lg-auto py-0 ">
                                            ...
                                            <select class="form-control d-flex d-flex align-items-center " wire:model.live="filters.status">
                                                <option value="">Selecciona un estatus...</option>
                                                <option value="create">Pendiente de pago</option>
                                                <option value="approved">Aprobado</option>
                                                <option value="pending">Deposito pendiente</option>
                                ...
                                <div class="col-12 col-md-8   align-self-md-center">
                                    <div class="search-panels">
                                        <div class="search-group">
                                            ...
                                            <label class="enter-label">Buscar por compra, email, WhatsApp, etc...</label>
                                            <div class="btn-box">
                        ...
                        <div class="col-12">
                            ...
                            <small class="text-muted">{{ $orders->count() }} resultados obtenidos.</small>
                            @if ($filters['status'] == 'approved')
                            <small class="text-muted">${{ number_format($ingresos, 2) }} MXN</small>
                            @endif
                            @endif
