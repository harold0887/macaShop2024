                                    ...
                                    <td>
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-lg-auto">
                                                ...
                                                <span class="d-block  text-muted my-1">Compra: {{ $item->order->id }}</span>
                                    ...
                                    <td>
                                        <div class="row mx-0">
                                            <div class="col-12">
                                                ...
                                                @if($item->product->folio == 1 && $item->order->active == 0 )
                                                ...
                                                <a href="https://api.whatsapp.com/send?phone=+9981838908&text=Quiero%20activar%20mi%20orden%20de%20compra%20web: {{ $item->order->id }}" target="_blank">
                                                    <img src="{{ asset('img/whatsapp1.png') }}" alt="logo WhatsApp" width="60">
                                                </a>
                                                @else
                                                <div wire:loading.remove>
                                                    <div>
                                                        <button class="btn btn-outline-info btn-round " wire:click="finalDownload({{ $item->product->id }},{{ $item->order->id }})" wire:loading.attr="disabled">
