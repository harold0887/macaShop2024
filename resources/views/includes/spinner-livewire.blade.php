<div wire:loading.delay id="modal-spinner-livewire" class="modal " style="background:rgba(255,255,255, 0.8);">
    <div class="modal-dialog   ">
        <div class=" text-center">
            <span class="text-primary fw-bold md:text-4xl  text-center  text-xl d-block mb-5">Cargando...</span>
            <div>
            ...
            <span class="text-primary fw-bold md:text-2xl  text-center  text-xl d-block mt-5">Por favor espere :)</span>
        </div>
    </div>
</div>