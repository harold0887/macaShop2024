                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-10">
                        ...
                        <div class="border rounded mt-4 p-2">
                            <p class="mb-2">Tu compra fue realizada con éxito y esta en espera del pago.</p>
                            <p class="small">
                                Recibirás un correo electrónico cuando el pago sea confirmado.
                            </p>
                        ...
                        <div class="text-center text-md-left mt-3 ">
                            <a href="{{ route('customer.orders') }}" class="btn   btn-round w-100 text-sm sm:text-base md:text-lg  lg:text-lg" style="background-color: #c09aed;">
                                Mis compras
                            </a>
                        </div>
                    </div>
